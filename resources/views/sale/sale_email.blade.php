                                                                                            ...
                                                                                            <table width="100%"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="fluid-img img-center pb-50"
                                                                                                        ...
                                                                                                        <img src="../images/img_intro_13.png"
                                                                                                            width="300"
                                                                                                            height="252"
                                                                                                            border="0"
                                                                                                            alt="" />
                                                                                                                    ...
                                                                                                                    <th class="column-top"
                                                                                                                        ...
                                                                                                                        <table
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td class="title-20 pb-10"
                                                                                                                                    style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; padding-bottom: 10px;">
                                                                                                                                    <strong>{{ $sale_detail->product->tittle }}</strong>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td class="text-16 lh-26 c-black"
                                                                                                                                    ...
                                                                                                                                    @if ($sale_detail->product_size_id && $sale_detail->product_color_size_id)
                                                                                                                                        <strong>Tamaño:</strong>
                                                                                                                                        {{ $sale_detail->product_size->name }}
                                                                                                                                        <br />
                                                                                                                                        <strong>Color:</strong>
                                                                                                                                        {{ $sale_detail->product_color_size->product_color->name }}
                                                                                                                                        <br />
                                                                                                                                    @endif

                                                                                                                                    <strong>Qty:</strong>
                                                                                                                                    {{ $sale_detail->cantidad }}
                                                                                                                                    <br />
                                                                                                                                    @if ($sale_detail->code_cupon)
                                                                                                                                        <strong>Cupon:</strong>
                                                                                                                                        {{ $sale_detail->code_cupon }}
                                                                                                                                        <br />
                                                                                                                                        <strong>Descuento:</strong>
                                                                                                                                        {{ $sale_detail->discount }}
                                                                                                                                        {{ $sale_detail->type_discount == 1 ? '%' : $sale->currency_total }}
                                                                                                                                        <br />
                                                                ...
                                                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                                                    ...
                                                                    <a href="tel:+17384796719" target="_blank"
                                                                        ...
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            ...
                                                                            479-6719</span></a> - <a
                                                                        href="tel:+13697181973" target="_blank"
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                    ...
                                                    <td class="text-12 lh-22 a-center c-grey- l-grey py-20"
                                                        ...
                                                        &nbsp;|&nbsp; <a href="#" target="_blank"
                                                            ...
                                                            style="text-decoration:none; color:#6e6e6e;"><span
                                                                ...
                                                                VERSION</span></a> &nbsp;|&nbsp; <a href="#"
                                                            target="_blank" class="link c-grey"
                                                            style="text-decoration:none; color:#6e6e6e;"><span
                                                                class="link c-grey"
